...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post autors_url, params: { autor: { email: @autor.email, nome: @autor.nome, password: @autor.password } }, as: :json
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { email: @autor.email, nome: @autor.nome, password: @autor.password } }, as: :json
    assert_response 200
  end
