...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { autor_id: @livro.autor_id, preco: @livro.preco, titulo: @livro.titulo } }, as: :json
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { autor_id: @livro.autor_id, preco: @livro.preco, titulo: @livro.titulo } }, as: :json
    assert_response 200
  end
